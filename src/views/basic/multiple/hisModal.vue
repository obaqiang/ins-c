 ...
 * @LastEditTime: 2021-12-27 19:18:20
-->
<!--  -->
<template>
  <a-modal
  ...
  >
    <s-table
      ...
      :columns="[
        ...
        {
          title: '审核状态',
          dataIndex: 'wxAuditStatus',
          scopedSlots: { customRender: 'wxAuditStatus' }
        },
        {
          title: '审核消息',
          dataIndex: 'wxAuditMsg'
        }
      ]"
      :data="loadData"
      :pagination="{
...
import { getHis, revertVersion } from '@/api/multiple/mini'
export default {
  props: {
    propVisible: {
      type: Boolean,
